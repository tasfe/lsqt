    ...
    <div title="center" region="center"  bodyStyle="overflow:hidden;">
	    ...
	    <div class="mini-fit" >
	        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" 
	            url="${ctx}/bpmFormField/list/${tableId}"  idField="ID" sortMode="client"
	            ...
	            <div property="columns">
	                ...
	                <div field="fieldId" width="120" headerAlign="center" allowSort="true">流水号</div>    
	                <div field="tableDesc" width="120" headerAlign="center" allowSort="true">表注释</div>  
	                <div field="tableName" width="120" headerAlign="center" allowSort="true">表名</div>  
	                
	                <div field="fieldDesc" width="120" headerAlign="center" allowSort="true">字段注释</div>
	                <div field="fieldName" width="120" headerAlign="center" allowSort="true">字段名</div>
