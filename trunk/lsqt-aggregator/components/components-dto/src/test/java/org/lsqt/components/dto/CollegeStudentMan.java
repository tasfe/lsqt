...
public class CollegeStudentMan extends CollegeStudent {
	...
	public String getReallyManDesc() {
		return reallyManDesc;
	}

	public void setReallyManDesc(String reallyManDesc) {
		this.reallyManDesc = reallyManDesc;
	}
