...
import weixin.popular.bean.BaseBean;
...
public class MenuAPI extends BaseAPI{
	 ...
	 * @return
	 */
	public BaseBean menuCreate(String access_token,String menuJson){
		MediaType mediaType = new MediaType("application","json",Charset.forName("UTF-8"));
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(mediaType);
		HttpEntity<String> httpEntity = new HttpEntity<String>(menuJson,headers);
		ResponseEntity<BaseBean> responseEntity = super.restTemplate.exchange(BASE_URI+"/menu/create?access_token={access_token}", HttpMethod.POST,httpEntity,BaseBean.class, access_token);
	 ...
	 * @return
	 */
	public BaseBean menuCreate(String access_token,MenuButtons menuButtons){
	...
	public Menu menuGet(String access_token){
		return super.restTemplate.postForObject(
				BASE_URI+"/menu/get?access_token={access_token}",
				null,
				Menu.class,
				access_token);
	}
	 ...
	 * @return
	 */
	public BaseBean menuDelete(String access_token){
		return super.restTemplate.postForObject(
				BASE_URI+"/menu/delete?access_token={access_token}",
				null,
				BaseBean.class,
				access_token);
	}
