...
public class QrcodeAPI extends BaseAPI{
	...
	private QrcodeTicket qrcodeCreate(String access_token,String qrcodeJson){
		...
		ResponseEntity<QrcodeTicket> responseEntity = super.restTemplate.exchange(BASE_URI+"/qrcode/create?access_token={access_token}", HttpMethod.POST,httpEntity,QrcodeTicket.class, access_token);
	...
	public ResponseEntity<ByteArrayResource> showqrcode(String ticket){
		try {
			return super.restTemplate.postForEntity("https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket={ticket}",
																null,
