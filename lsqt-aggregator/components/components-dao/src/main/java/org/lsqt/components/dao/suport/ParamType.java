...
//			    public static final int NCHAR = org.h2.value.DataType.TYPE_NCHAR;
			     ...
			     * @since 1.6
			     */
//			   public static final int NVARCHAR = org.h2.value.DataType.TYPE_NVARCHAR;
...
//			   public static final int LONGNVARCHAR = java.sql.Types.LONGVARCHAR;
			     ...
			     * @since 1.6
			     */
//			   public static final int NCLOB = org.h2.value.DataType.TYPE_NCLOB;
...
//			    public static final int SQLXML = java.sql.Types.SQLXML;
			    ...
			    /**
			     * The sql holder , replace "?" paramType
			     */
